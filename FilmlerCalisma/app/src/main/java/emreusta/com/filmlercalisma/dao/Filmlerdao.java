package emreusta.com.filmlercalisma.dao;
...
import emreusta.com.filmlercalisma.objects.Kategoriler;
import emreusta.com.filmlercalisma.objects.Yonetmenler;
...
public class Filmlerdao {
    ...
    public ArrayList<Filmler> tumFilmler(VeritabaniYardimcisi vt){
        ...
        while (c.moveToNext()){
            Kategoriler k = new Kategoriler(c.getInt(c.getColumnIndex("film_id")),
